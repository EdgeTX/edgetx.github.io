...
<p></p> 
<p align="center">
<a><img src="/assets/EdgeTXFest2026Col.jpg?raw=true" align="center" width="1024"></a>
</P>

Our 2026 EdgeTX Fest, together with our project's 5th birthday celebrations, were carried out at the <a href="https://www.airshowinternational.co.uk/">Weston Park Model Airshow</a> in West-Midlands in the United Kingdom.

During the three event days, event’s attendees had the opportunity to meet some of the people behind EdgeTX development and project management. We displayed in our booth a variety of EdgeTX driven radios, and all visitors could have a hands-on experience with our software and supported hardware. Like every year, thanks to our sponsors, all radios shown were then raffled to visitors who decided to participate.

To show EdgeTX capabilities this year we prepared a RC controlled ball-maze and a 3D printed model forklift and warehouse shelves. Both were very popular attractions and many, also younger visitors, could try to manoeuvre the palettes using an EdgeTX radio.

To celebrate EdgeTX 5th birthday, we had a RC radio shaped cake made by <a href="https://www.perfectlyplumcakes.co.uk/">Perfectly Plum Cakes</a>. A big shout out to Tor Swann for doing an absolutely amazing job with the cake.

We extend our heartfelt gratitude to everyone who joined us at the 2026 Fest to celebrate the 5th year of EdgeTX. Your overwhelming presence and engaging interactions made this event truly unforgettable. A big congratulations to all the lucky drawing winners!
...
We are excited to announce the winner of the EdgeTX Buddy Backup and Restore Developer Contest - Héctor Narbona Márquez! As a token of appreciation for his outstanding contribution, Héctor will receive a [black RadioMaster TX16s radio with internal ExpressLRS module](https://radiomasterrc.com/products/tx16s-mk3-radio-controller). For successfully also completing the bonus task to create a standalone app with the same features, Héctor will also receive a [RadioMaster ER8 ExpressLRS receiver](https://radiomasterrc.com/products/er8-2-4ghz-elrs-pwm-receiver). Both winning items were selected by Héctor from the available options and are generously sponsored by RadioMaster. For the winning submission, please see [EdgeTX Buddy PR #134](https://github.com/EdgeTX/buddy/pull/134). We extend our heartfelt congratulations to Héctor Narbona Márquez for this well-deserved win.
...
**3D printable model of EdgeTX mascot *Eddie the Edgehog* Developer Contest**

Create the best volumetric 3D printable model of EdgeTX mascot *Eddie the Edgehog* together with EdgeTX star logo and win a RadioMaster TX16s MK3 MAX radio. The contest ends on <del>midnight of March 1st, 2026 GMT</del> <span style="color:red;font-weight:bold;">extended to midnight of March 31st, 2026 GMT</span>. Full contest details and rules can be found here: [https://edgetx.org/dc10_3deddie](https://edgetx.org/dc10_3deddie)
...
**Lua LVGL New Model Wizard Developer Contest Winner**

We are excited to announce the winner of the Lua LVGL New Model Wizard Developer Contest - Alexander Gnauck! As a token of appreciation for his outstanding contribution, Alexander will receive a RadioMaster TX15 MAX Black radio with internal 2.4 GHz ExpressLRS module (per his request), generously sponsored by RadioMaster. This state-of-the-art radio will be shipped worldwide free of charge directly from the RadioMaster factory to Alexander. We extend our heartfelt congratulations to Alexander Gnauck for this well-deserved win.
...
**Lua LVGL New Model Wizard Developer Contest**


Be the first developer to rewrite the model wizards (Plane, Glider, Wing, Helicopter and Multirotor) so that they use the new EdgeTX Lua LVGL controls and automatically adapt to screen resolution and win a RadioMaster radio. The contest ends after first successful submission or on midnight of January 18th, 2026 GMT.  Full contest details and rules can be found here: [https://edgetx.org/dc9_lualvglwizard](https://edgetx.org/dc9_lualvglwizard)
...
***EdgeTX Buddy Backup and Restore Developer Contest***

Be the first developer to add a model and radio settings backup and restore functionality for EdgeTX Buddy and you will win a RadioMaster radio (the winner can pick a radio model between RadioMaster TX16s mkII, GX12, Boxer, MT12, Zorro or Pocket). The contest ends after first successful submission or on midnight April 30th, 2025 GMT. Full contest details and rules can be found here: [https://edgetx.org/dc6_buddybackup](https://edgetx.org/dc6_buddybackup)

***Haptic Feedback for EdgeTX Companion Simulator Developer Contest***

Be the first developer to add visual and audible haptic feedback for EdgeTX Companion Simulator for all presently supported OS (MacOS/Linux/Windows) and you will win a RadioMaster radio (the winner can pick a radio model between RadioMaster TX16s mkII, GX12, Boxer, MT12, Zorro or Pocket). The contest ends after first successful submission or on midnight April 30th, 2025 GMT. Full contest details and rules can be found here: [https://edgetx.org/dc7_simuhaptic](https://edgetx.org/dc7_simuhaptic)

***Lua widget using LVGL controls***

Create the most popular new Lua widget using LVGL controls for EdgeTX color screen radios and you will win a RadioMaster radio (the winner can pick a radio model between RadioMaster TX16s mkII, GX12, Boxer, MT12, Zorro or Pocket). The contest ends on midnight of April 30th, 2025 GMT and the winner is picked by the amount of thumb ups the community has provided to the PR by that date. Full contest details and rules can be found here: [https://edgetx.org/dc8_lualvglwidget](https://edgetx.org/dc8_lualvglwidget)
