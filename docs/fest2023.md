...
- 2x RadioMaster TX16s mkII (one per day)
- 2x RadioMaster Boxer (one per day)
- 2x RadioMaster TX12 mkII (one per day)
- 2x RadioMaster Zorro (one per day)
- 2x RadioMaster Pocket (one per day)
- 4x Jumper T20 (two per day)
- 4x Jumper T-Pro v2 (two per day)
- 2x BetaFPV LightRadio3 Pro (one per day)
- 1x Flysky EL18 (the winner will be drawn on Sunday)
- 1x Flysky FRM303 AFHDS3 radio module (the winner will be drawn on Sunday)
- 1x Flysky FS-HZCZ03-ADJ digital hall gimbal assembly set  (the winner will be drawn on Sunday)
