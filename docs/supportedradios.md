...
* Jumper T-Lite / T-Lite v2 (since v2.4, v2.11 is the last version to support this radio)
* Jumper T-Pro (since v2.6, v2.11 is the last version to support this radio)
* Jumper T-Pro v2 (since v2.10)
* Jumper T-Pro S (since v2.10.3)
* Jumper T12 / T12 Plus / T12 Pro Hall (since v2.4, v2.11 is the last version to support this radio)
...
* RadioMaster MT12 (since v2.10, Companion support since v2.11)
* RadioMaster Pocket (since v2.10)
* RadioMaster T8 Pro (since v2.4, v2.11 is the last version to support this radio)
* RadioMaster TX12 (since v2.4, v2.11 is the last version to support this radio)
